...
function KakaoIcon({className}: IconProps): JSX.Element {
    return (
        <svg
...
function FaceBookIcon({className}: IconProps): JSX.Element {
    return (
        <svg className={cn('fill-current', className)} viewBox='0 0 48 48'>
...
function ThunderIcon({className}: IconProps): JSX.Element {
    return (
        <svg className={cn('fill-current', className)} viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
            <g fill="none">
                <polygon fill="#5EA7FF"
                         points="27.921 21 16.718 21 7 42.027 16.997 42.027 9.86 60.034 30.038 36.016 18.905 36.016"/>
                <polygon fill="#5EA7FF"
                         points="53.921 8 42.718 8 33 29.027 42.997 29.027 35.86 47.034 56.038 23.016 44.905 23.016"/>
            </g>
        </svg>
    );
}
