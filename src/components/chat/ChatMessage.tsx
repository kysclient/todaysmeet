            ...
            <div
                ...
                <div className="prose mt-[-2px] w-full dark:prose-invert">
                  ...
                  />
                            ...
                            {!isEditing && (
                                <div
                                    className="md:-ml-20 flex flex-col md:flex-row gap-4 md:gap-1 items-center md:items-start justify-end md:justify-start">
                                    <button
                        ...
                        <div className="flex flex-row">
                            ...
                            >
                                {`${message.content}${
                                    messageIsStreaming && messageIndex == (messages.length ?? 0) - 1 ? '`▍`' : ''
                                }`}
                            </MemoizedReactMarkdown>
